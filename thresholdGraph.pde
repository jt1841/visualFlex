...
ThresholdGraph(){
  ...
  void update(){
    ...
    for (int i = 0; i < xPosArr.length; i++){
      ...
      if (i == 0){ fill(0, 255, 38); inputName = "one";}
      if (i == 1){ fill(255, 51, 156); inputName = "two";}
      if (i == 2){ fill(234, 255, 0); inputName = "three";}
      if (i == 3){ fill(255, 82, 0); inputName = "four";}
      if (i == 4){ fill(0, 136, 255); inputName = "five";}
      // draw poti at xpos 
